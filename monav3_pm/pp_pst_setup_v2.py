...
for par in params : 
    ...
    marthe_utils.write_grid_file('{0}.i{1}'.format(mm.mlname,par),x,y,izone)
    # Setup zpc
...
pst.parameter_data.loc[ pst.parameter_data['pargp'] == 'emmca' , 'parubnd'] =  10**3
pst.parameter_data.loc[ pst.parameter_data['pargp'] == 'emmli' , 'parubnd'] =  10**3
pst.parameter_data.loc[ pst.parameter_data['pargp'] == 'permh' , 'parubnd'] =  10**3
pst.parameter_data.loc[ pst.parameter_data['pargp'] == 'kepon' , 'parubnd'] =  10**3
...
pst.parameter_groups.loc[ pst.parameter_groups.index,'forcen'] = 'switch'
...
# write pst 
pst.write(mm.mlname + 'test_pp.pst')
